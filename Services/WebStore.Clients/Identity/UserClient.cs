...
namespace WebStore.Clients.Identity
{
    ...
    {
        public UserClient(IConfiguration config) : base(config, WebApi.Identity.Users)
        {
        ...
        {
            return await (await PostAsync($"{_ServiceAdress}/UserId", user, cancel))
               .Content
        ...
        {
            return await (await PostAsync($"{_ServiceAdress}/UserName", user, cancel))
               .Content
               .ReadAsAsync<string>(cancel)
               .ConfigureAwait(false);
        }
        ...
        {
            user.UserName = name;
            await PostAsync($"{_ServiceAdress}/UserName/{name}", user, cancel);
        }

        public async Task<string> GetNormalizedUserNameAsync(User user, CancellationToken cancel)
        {
            return await (await PostAsync($"{_ServiceAdress}/NormalUserName/", user, cancel))
               .Content
               .ReadAsAsync<string>(cancel)
               .ConfigureAwait(false);
        }
        ...
        public async Task SetNormalizedUserNameAsync(User user, string name, CancellationToken cancel)
        {
            ...
            await PostAsync($"{_ServiceAdress}/NormalUserName/{name}", user, cancel);
        }

        public async Task<IdentityResult> CreateAsync(User user, CancellationToken cancel)
        {
            return await (await PostAsync($"{_ServiceAdress}/User", user, cancel))
               .Content
        ...
        {
            return await (await PutAsync($"{_ServiceAdress}/User", user, cancel))
               .Content
               .ReadAsAsync<bool>(cancel)
                ? IdentityResult.Success
                : IdentityResult.Failed();
        ...
        {
            return await (await PostAsync($"{_ServiceAdress}/User/Delete", user, cancel))
               .Content
               .ReadAsAsync<bool>(cancel)
                ? IdentityResult.Success
                : IdentityResult.Failed();
        ...
        {
            return await GetAsync<User>($"{_ServiceAdress}/User/Find/{id}", cancel);
        }

        public async Task<User> FindByNameAsync(string name, CancellationToken cancel)
        {
            return await GetAsync<User>($"{_ServiceAdress}/User/Normal/{name}", cancel);
        }
        ...
        {
            await PostAsync($"{_ServiceAdress}/Role/{role}", user, cancel);
        }

        public async Task RemoveFromRoleAsync(User user, string role, CancellationToken cancel)
        {
            await PostAsync($"{_ServiceAdress}/Role/Delete/{role}", user, cancel);
        }

        public async Task<IList<string>> GetRolesAsync(User user, CancellationToken cancel)
        {
            return await (await PostAsync($"{_ServiceAdress}/roles", user, cancel))
               .Content
        ...
        {
            return await (await PostAsync($"{_ServiceAdress}/InRole/{role}", user, cancel))
               .Content
               .ReadAsAsync<bool>(cancel);
        }
        ...
        {
            return await GetAsync<List<User>>($"{_ServiceAdress}/UsersInRole/{role}", cancel);
        }
        ...
        public async Task SetPasswordHashAsync(User user, string hash, CancellationToken cancel)
        {
            ...
            await PostAsync(
                $"{_ServiceAdress}/SetPasswordHash", new PasswordHashDTO { Hash = hash, User = user },
                cancel);
        }

        public async Task<string> GetPasswordHashAsync(User user, CancellationToken cancel)
        {
            return await (await PostAsync($"{_ServiceAdress}/GetPasswordHash", user, cancel))
               .Content
               .ReadAsAsync<string>(cancel);
        }
        ...
        {
            return await (await PostAsync($"{_ServiceAdress}/HasPassword", user, cancel))
               .Content
               .ReadAsAsync<bool>(cancel);
        }
        ...
        {
            user.Email = email;
            await PostAsync($"{_ServiceAdress}/SetEmail/{email}", user, cancel);
        }

        public async Task<string> GetEmailAsync(User user, CancellationToken cancel)
        {
            return await (await PostAsync($"{_ServiceAdress}/GetEmail", user, cancel))
               .Content
               .ReadAsAsync<string>(cancel);
        }
        ...
        {
            return await (await PostAsync($"{_ServiceAdress}/GetEmailConfirmed", user, cancel))
               .Content
               .ReadAsAsync<bool>(cancel);
        }
        ...
        public async Task SetEmailConfirmedAsync(User user, bool confirmed, CancellationToken cancel)
        {
            ...
            await PostAsync($"{_ServiceAdress}/SetEmailConfirmed/{confirmed}", user, cancel);
        }

        public async Task<User> FindByEmailAsync(string email, CancellationToken cancel)
        {
            return await GetAsync<User>($"{_ServiceAdress}/User/FindByEmail/{email}", cancel);
        }

        public async Task<string> GetNormalizedEmailAsync(User user, CancellationToken cancel)
        {
            return await (await PostAsync($"{_ServiceAdress}/User/GetNormalizedEmail", user, cancel))
               .Content
               .ReadAsAsync<string>(cancel);
        }
        ...
        public async Task SetNormalizedEmailAsync(User user, string email, CancellationToken cancel)
        {
            ...
            await PostAsync($"{_ServiceAdress}/SetNormalizedEmail/{email}", user, cancel);
        }
        ...
        public async Task SetPhoneNumberAsync(User user, string phone, CancellationToken cancel)
        {
            ...
            await PostAsync($"{_ServiceAdress}/SetPhoneNumber/{phone}", user, cancel);
        }

        public async Task<string> GetPhoneNumberAsync(User user, CancellationToken cancel)
        {
            return await (await PostAsync($"{_ServiceAdress}/GetPhoneNumber", user, cancel))
               .Content
               .ReadAsAsync<string>(cancel);
        }
        ...
        {
            return await (await PostAsync($"{_ServiceAdress}/GetPhoneNumberConfirmed", user, cancel))
               .Content
               .ReadAsAsync<bool>(cancel);
        }
        ...
        public async Task SetPhoneNumberConfirmedAsync(User user, bool confirmed, CancellationToken cancel)
        {
            ...
            await PostAsync($"{_ServiceAdress}/SetPhoneNumberConfirmed/{confirmed}", user, cancel);
        }
        ...
        {
            await PostAsync($"{_ServiceAdress}/AddLogin", new AddLoginDTO { User = user, UserLoginInfo = login }, cancel);
        }

        public async Task RemoveLoginAsync(User user, string LoginProvider, string ProviderKey, CancellationToken cancel)
        {
            await PostAsync($"{_ServiceAdress}/RemoveLogin/{LoginProvider}/{ProviderKey}", user, cancel);
        }

        public async Task<IList<UserLoginInfo>> GetLoginsAsync(User user, CancellationToken cancel)
        {
            return await (await PostAsync($"{_ServiceAdress}/GetLogins", user, cancel))
               .Content
        ...
        {
            return await GetAsync<User>($"{_ServiceAdress}/User/FindByLogin/{LoginProvider}/{ProviderKey}", cancel);
        }
        ...
        {
            return await (await PostAsync($"{_ServiceAdress}/GetLockoutEndDate", user, cancel))
               .Content
        ...
        public async Task SetLockoutEndDateAsync(User user, DateTimeOffset? EndDate, CancellationToken cancel)
        {
            ...
            await PostAsync(
                $"{_ServiceAdress}/SetLockoutEndDate",
        ...
        {
            return await (await PostAsync($"{_ServiceAdress}/IncrementAccessFailedCount", user, cancel))
               .Content
        ...
        {
            await PostAsync($"{_ServiceAdress}/ResetAccessFailedCont", user, cancel);
        }

        public async Task<int> GetAccessFailedCountAsync(User user, CancellationToken cancel)
        {
            return await (await PostAsync($"{_ServiceAdress}/GetAccessFailedCount", user, cancel))
               .Content
               .ReadAsAsync<int>(cancel);
        }
        ...
        {
            return await (await PostAsync($"{_ServiceAdress}/GetLockoutEnabled", user, cancel))
               .Content
               .ReadAsAsync<bool>(cancel);
        }
        ...
        public async Task SetLockoutEnabledAsync(User user, bool enabled, CancellationToken cancel)
        {
            ...
            await PostAsync($"{_ServiceAdress}/SetLockoutEnabled/{enabled}", user, cancel);
        }
        ...
        public async Task SetTwoFactorEnabledAsync(User user, bool enabled, CancellationToken cancel)
        {
            ...
            await PostAsync($"{_ServiceAdress}/SetTwoFactor/{enabled}", user, cancel);
        }

        public async Task<bool> GetTwoFactorEnabledAsync(User user, CancellationToken cancel)
        {
            return await (await PostAsync($"{_ServiceAdress}/GetTwoFactorEnabled", user, cancel))
               .Content
               .ReadAsAsync<bool>(cancel);
        }
        ...
        {
            return await (await PostAsync($"{_ServiceAdress}/GetClaims", user, cancel))
               .Content
        ...
        {
            await PostAsync($"{_ServiceAdress}/AddClaims", new AddClaimDTO { User = user, Claims = claims }, cancel);
        }

        public async Task ReplaceClaimAsync(User user, Claim OldClaim, Claim NewClaim, CancellationToken cancel)
        {
            await PostAsync(
                $"{_ServiceAdress}/ReplaceClaim",
        ...
        {
            await PostAsync(
                $"{_ServiceAdress}/RemoveClaims", new RemoveClaimDTO { User = user, Claims = claims },
                cancel);
        }

        public async Task<IList<User>> GetUsersForClaimAsync(Claim claim, CancellationToken cancel)
        {
            return await (await PostAsync($"{_ServiceAdress}/GetUsersForClaim", claim, cancel))
               .Content
