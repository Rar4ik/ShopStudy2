...
namespace WebStore.TagHelpers
{
    ...
    public class ActiveRouteTagHelper : TagHelper
    {
        ...
        private IDictionary<string,string> RouteValuesDictionary { get; set; }
        ...
        private bool IsActive(bool IgnoreAction)
        {
            ...
            const StringComparison igonre_case = StringComparison.OrdinalIgnoreCase;

            if (!string.IsNullOrWhiteSpace(Controller) && !string.Equals(Controller, current_controller, igonre_case))
                return false;
            if (!IgnoreAction && !string.IsNullOrWhiteSpace(Action) && !string.Equals(Action, current_action, igonre_case))
                return false;
